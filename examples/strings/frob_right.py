...
d1.add_arrow('B2','delta',angleA=90,angleB=-90) 
d1.add_arrow('nabla','delta',angleA=0,angleB=180)
d1.add_arrow('delta','T2',angleA=0,angleB=-90)
d1.add_arrow('nabla','T1',angleA=90,angleB=-90)
