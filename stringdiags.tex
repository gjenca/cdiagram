...
%% else
\nccurve[arrowscale=0.7,ArrowInside=-T>
,ArrowInsidePos=<<arrow.inside_pos|default(0.75)>>,nodesep=0,linecolor=<<arrow.color|default('black')>>,angleA=<<arrow.angleA|default(90)>>,angleB=<<arrow.angleB|default(-90)>>,linewidth=<<arrow.linewidth|default('0.7pt')>>,ncurv=<<arrow.ncurv|default(0.75)>>]{-}
{<<arrow.from_node.name>>}{<<arrow.to_node.name>>}
%% endif
%% if arrow.label
