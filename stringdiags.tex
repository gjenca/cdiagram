...
\cnode<<node.position>>{<<node.radius|default('0.07')>>}{<<node.name>>}
%% else
...
\nbput[npos=<<arrow.npos|default('0.5')>>,labelsep=<<arrow.labelsep | default('0.5pt')>>]{$<<arrow.label>>$}
%% else
\naput[npos=<<arrow.npos|default('0.5')>>,labelsep=<<arrow.labelsep | default('0.5pt')>>]{$<<arrow.label>>$}
%% endif
%% endif 
%% endif
%% endfor
